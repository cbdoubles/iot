...
SECRET_KEY = 'django-insecure-rn5x_97e2fhs_(2lm!n-mu$$_0db+%t6$8$=l*--pn@k!s@9a8'
...
MIDDLEWARE = [ #code that goes in the backend
    'django.middleware.security.SecurityMiddleware',
    'django.contrib.sessions.middleware.SessionMiddleware',
    'corsheaders.middleware.CorsMiddleware', #goes to this code before next part of django code
